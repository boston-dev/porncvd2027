...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=364828');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "364828");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "e94af30afc1d7c6c2758362c71e183f25e7afb9617f4958deb73edc2a9dfb004");
define('CREATED_TIMESTAMP', "1696749109");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor364828');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor364828');
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "porncvd.com",
));
